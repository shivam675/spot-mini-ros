...
# urdf_path = pkg_path + '/scripts/official_pybullet_files/spot/spot.urdf'
# /home/ros/custom_ai/src/spot_mini_ros
    ...
    """
        ...
        if reload_urdf:
            if self._self_collision_enabled:
                self.quadruped = self._pybullet_client.loadURDF(urdf_path,
                    init_position,
